/*
    09) Construa uma função para um sistema de notas de uma instituição que possui a seguinte política de classificação: 
        ...
        Por exemplo, a nota 84 será arredondada para 85, mas a nota 29 não será arredondada por ser abaixo de 40 e 
        não ser possível arredondamento eficiente, ou seja, que evite a reprovação do aluno. No caso de a nota ser 38, 
...
function calculaNota(nota) {
    ...
    if (notaCorrigida >= 40) {
        console.log(`Aluno Aprovado:  ${notaCorrigida}`)
    } else {
        console.log(`Aluno Reprovado: ${notaCorrigida}`)
    }
}
