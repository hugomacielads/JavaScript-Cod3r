/*
    ...
    retornar um vetor com o número de vezes que ele bateu seu recorde de maior número de pontos 
...
function avaliaPontuacoes (stringPontuacoes) {
    ...
    for (let i = 1; i < pontuacoes.length; i++) {
        if(pontuacoes[i] > maiorPontuacao) {
            ...
            piorJogo = i+1; //Verifica qual foi o pior jogo e não quantos pontos foram feitos
        }
    }
